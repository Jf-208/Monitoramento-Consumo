    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }} edges={['top', 'bottom']}>
      ...
      >
        ...
        <View style={{
          ...
          <Text style={{ color: colors.textSub || colors.text, fontSize: 13, flex: 1, lineHeight: 19 }}>
            Tire suas dúvidas sobre como usar o Wavunder e entender seus dados de consumo.
          </Text>
        </View>
        ...
        {FAQ.map((item, idx) => (
          <View key={idx} style={{
            ...
            {/* Resposta */}
            <Text style={{ color: colors.textSub || colors.text, fontSize: 13, lineHeight: 21 }}>
              {item.resposta}
            </Text>
          </View>
        ))}
        ...
        <View style={{
          ...
          <Text style={{ color: colors.textSub || colors.text, fontSize: 12, textAlign: 'center', lineHeight: 17 }}>
