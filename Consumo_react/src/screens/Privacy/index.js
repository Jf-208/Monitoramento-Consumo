...
const SECOES = [
  ...
  },
  {
    ...
    texto:
      "Seus dados são mantidos enquanto sua conta estiver ativa. Você pode solicitar a exclusão da sua conta e todos os dados associados a qualquer momento, resultando na remoção permanente de todas as suas informações do banco de dados.",
  },
  {
  ...
  },
  {
    ...
    texto:
      "O Wavunder é um projeto desenvolvido para fins acadêmicos na disciplina de Desenvolvimento de Sistemas. O código-fonte é aberto e está disponível no repositório GitHub do projeto. Não há fins comerciais.",
  },
  {
    icone: "refresh-outline",
    titulo: "9. Atualizações desta Política",
    texto:
      "Esta política pode ser atualizada ao longo do desenvolvimento do projeto. A versão mais recente estará sempre disponível nesta tela. Última atualização: maio de 2026.",
  },
];
