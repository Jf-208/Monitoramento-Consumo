...
export default function HomeScreen({ navigation }) {
  ...
  useEffect(() => {
    const carregarDicaDoDia = async () => {
      try {
        ...
        const novaDica =
          dicasValidas[Math.floor(Math.random() * dicasValidas.length)];
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.greeting, { textAlign: "center", marginTop: 10 }]}>
      ...
      >
        ...
        >
          ...
          <Text
            style={[
              styles.heroTitle,
              { color: nivel.cor, textAlign: "center" },
            ]}
          >
        ...
        <View style={styles.statsCard}>
          {isLoadingBackend ? (
            <View style={{ alignItems: "center", paddingVertical: 20 }}>
              ...
              <Text
                style={{ color: colors.textMuted, marginTop: 8, fontSize: 12 }}
              >
                Carregando dados...
              </Text>
            </View>
      ...
      >
        <View
          style={[styles.statsCard, { marginTop: 8, alignItems: "center" }]}
        >
          <Text
            style={{
            ...
            >
              {dicaDoDia.icon ? (
                <Ionicons
                  name={dicaDoDia.icon}
                  size={24}
                  color={dicaDoDia.cor || colors.teal}
              ...
              <Text
                style={{ color: colors.textSub, fontSize: 13, lineHeight: 20 }}
              >
                {dicaDoDia.desc}
              </Text>
            </View>
